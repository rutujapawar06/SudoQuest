...
public class Sudoku {
              ...
              for(int r = 0; r < 9; r++) {
                     for(int c =0; c < 9;c++){
                            ...
                            if(tileChar != '-'){
                                   ...
                                   tile.setBackground(new Color(255, 179, 186));
                            }
                            else{
       ...
       void setupButtons(){
              for(int i = 1; i < 10; i++){ //255, 215, 220
                     JButton button = new JButton();
                     button.setFont(new Font("Arial",Font.BOLD,20));
                     button.setText(String.valueOf(i));
                     button.setFocusable(false);
                     // button.setBackground(Color.white);
                     button.setBackground(new Color(255, 230, 235));
                     ...
                     button.addActionListener(new ActionListener() {
                            ...
                            numSelected = button;
                           numSelected.setBackground(new Color(255, 179, 186));
